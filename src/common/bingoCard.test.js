...
function testCard(cardMatrix) {
  let pass = false;
  let RowBreakException = {
    message: "There are not 4 empty cells in a row",
    name: "RowBreakException",
  };
  let ColBreakException = {
    message: "3 empty cells in a col",
    name: "ColBreakException",
  };
  let NotSortedException = {
    message: "Column not sorted ASC",
    name: "NotShortedException",
  };
  try {
